...
All interfaces and the concrete types that implement them must be registered.
 ...
 amino.RegisterConcrete(MyStruct1{}, "com.mydexchain/MyStruct1", nil)
 amino.RegisterConcrete(MyStruct2{}, "com.mydexchain/MyStruct2", nil)
...
prefixed by a unique entity name such as "com.mydexchain/", and not
...
and drop the leading 0x00 bytes.
 ...
 > hash := sha256("com.mydexchain.consensus/MyConcreteName")
