...
func main() {
	...
	as := tests.ArraysStruct{
		...
		StringAr:  [4]string{"mydexchain", "Fuzzing", "Blue", "410DDC670CF9BFD7"},
	...
	ss := tests.SlicesStruct{
		...
		StringSl:  []string{"mydexchain", "Fuzzing", "Blue", "410DDC670CF9BFD7"},
	...
	cdc := amino.NewCodec()
	cdc.RegisterConcrete(&tests.ComplexSt{}, "com.mydexchain/complex_st", nil)
	cdc.RegisterConcrete(&tests.PrimitivesStruct{}, "com.mydexchain/primitive_st", nil)
	cdc.RegisterConcrete(&tests.ArraysStruct{}, "com.mydexchain/arrays_st", nil)
	cdc.RegisterConcrete(&tests.SlicesStruct{}, "com.mydexchain/slices_st", nil)
